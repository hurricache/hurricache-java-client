...
| **Очередь (QUEUE)** | `createQueue`, `getSize`, `getAndRemoveFront`, `getHead`, `addElementToTail`, `removeHead`, `streamList`, `streamSet`, `streamElementInRangeUnordered`, `addElement`, `getAndRemoveElementAtPosition`, `removeElementAtPosition`, `removeFromContainer`, `setTtl`, `getTtl`, `existKey`, `remove`, `lockObject`, `unlockObject` |
