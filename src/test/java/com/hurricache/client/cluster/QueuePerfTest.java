...
public class QueuePerfTest {
    ...
    private static final String QUEUE_NAME = "perf-test-queue-" + System.currentTimeMillis();
    ...
    private void writeMessagesLoop(int writerId, PerfMetrics metrics, java.util.function.BooleanSupplier isRunning) {
        ...
        while (isRunning.getAsBoolean()) {
            try {
                ...
                client.addElementToTail(QUEUE_NAME, queueKeyHint, List.of(payload)).whenComplete((success, ex) -> {
    ...
    private void readMessagesLoop(int readerId, PerfMetrics metrics, java.util.function.BooleanSupplier isRunning) {
        ...
        while (isRunning.getAsBoolean()) {
            try {
                ...
                client.getAndRemoveFront(QUEUE_NAME, queueKeyHint).whenComplete((resp, ex) -> {
